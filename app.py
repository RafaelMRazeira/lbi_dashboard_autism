...
from lbi_dashboard_autism.const import (
    CONFIG,
    ESTADOS,
    LOCALIZACAO,
    UF_TO_REGION,
...
cache = Cache(
    app.server, config={"CACHE_TYPE": "filesystem", "CACHE_DIR": get_cache_dir()}
)
...
# ==== Abas ====
@app.callback(Output("tabs-content", "children"), Input("tabs-LBI", "value"))
        ...
        return (
            html.Div(
                [
                    ...
                    html.H4(
                        children="DASHBOARD PARA VISUALIZAÇÃO DE DADOS PROCESSUAIS DA LEI BRASILEIRA DE INCLUSÃO",
                        style={
                            "textAlign": "center",
                            "color": "#252423",
                            "margin-bottom": "10px",
            ...
            [
                html.Div(
                    [
                        ...
                        # MAPA
                        html.Div(
                            [html.Div(dcc.Graph(id="choropleth-map-amount"))], style={}
                        ),
                    ],
                    style={
                        "background-color": "#fff",
            ...
            [
                html.Div(
                    [
                        ...
                        # MAPA
                        html.Div(
                            [html.Div(dcc.Graph(id="choropleth-map-demand"))], style={}
                        ),
                    ],
                    style={
                        "background-color": "#fff",
